...
const selected = ref(GENRES_NT[0])
...
<template>
  <div class="flex py-1 mt-2 grid relative items-center mr-4 w-[180px]">
    <h2 class="my-2 font-secondary custom-title lg:text-3xl text-center">(1) Thể loại</h2>
    <Listbox v-model="selected">
      <ListboxButton
          class="btn bg-deep-black flex items-center border-white text-white flex justify-between w-[180px]"
