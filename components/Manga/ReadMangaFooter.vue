  ...
  <div class="h-[200px] w-full overflow-hidden py-4">
    <div class="mx-auto flex h-full w-full flex-col space-y-4 md:w-1/2">
      <div class="flex h-full w-full gap-4">
        ...
        <button @click="next" data-id="next"
      ...
      <h1 class="py-4 px-2 text-center text-white/75">
        Mẹo: Bạn có thể double tap/click vào 2 cạnh của màn hình để chuyển chap ở bất cứ vị trí nào ở chế độ dọc!</h1>
    </div>
  </div>
</template>