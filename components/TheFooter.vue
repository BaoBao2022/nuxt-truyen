...
<template>
  <div class="w-full flex flex-col items-center justify-center px-4 md:px-12 py-16 space-y-4">
    ...
    <div class="flex items-center space-x-4">
      <a href="/" target="_blank" rel="noreferrer">
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 640 512"
             class="w-6 h-6 hover:text-primary-500 transition duration-300" height="1em" width="1em"
    ...
    <div class="flex items-center space-x-8 text-center">
      <a class="hover:text-primary-300 transition duration-300" href="/">
        <p class="text-lg">Điều khoản dịch vụ</p>
      </a>
      <!--      <a class="hover:text-primary-300 transition duration-300" href="/vi/dmca">-->
      <!--        <p class="text-lg">DMCA</p>-->
      <!--      </a>-->
      <a
          class="hover:text-primary-300 transition duration-300" href="/">
        <p class="text-lg">Liên hệ</p>
      </a>
    </div>
    <p class="text-sm text-gray-300 text-center">{{ config.public.SIZE_NAME }} không lưu trữ bất kì tệp tin nào trên máy
      chủ, chúng tôi chỉ
      liên kết tới những phương tiện truyền thông được lưu trữ bên dịch vụ thứ 3.</p>
    <p class="text-sm text-gray-300 text-center">© {{ config.public.DOMAIN }}</p></div>
</template>
