...
<template>
  <form
      @click="open"
      class="ml-16 flex h-[40%] w-fit items-center justify-between rounded-2xl  bg-white shadow-xl shadow-white/20 lg:w-[68%]">
    <button
      ...
      <div class="fixed inset-0 overflow-y-auto">
        <div class="flex min-h-full justify-center p-4 text-center">
          <TransitionChild
            ...
            <DialogPanel
                class="fixed top-[10%] left-0 right-0 overflow-y-auto">
              <div class="flex min-h-full items-center justify-center p-4 text-center">
                <div
                  ...
                  <div class="flex items-center justify-between"><h3
                      class="my-4 mx-2 font-secondary text-4xl leading-6 text-white md:text-6xl">
                    Tìm Truyện
                  </h3>
                  ...
                  <div
                      v-if="!hasResult && !loading && refInput.length > 0"
