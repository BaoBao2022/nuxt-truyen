...
import { navigateTo, useAsyncData, useHead, useState, watchEffect } from "#imports";
        ...
        <figure class="deslide-cover">
          <span
            style="box-sizing: border-box; display: block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: absolute; inset: 0px;"><img
              alt="comic-banner" :src="comic.thumbnail" decoding="async" data-nimg="fill"
              class=" count={10} object-fit absolute h-full w-full bg-cover bg-top bg-no-repeat object-cover blur"
              sizes="100vw" :srcset="comic.thumbnail"
        ...
        <section class="h-fit w-full">
          <div class="flex h-full w-full flex-col items-center overflow-x-hidden md:flex-row md:items-start">
            <div class="mt-4 w-[50%] md:w-[250px] md:min-w-[250px]">
              <figure class="aspect-w-3 aspect-h-5 relative rounded-sm">
                <span
                  style="box-sizing: border-box; display: block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: absolute; inset: 0px;">
                  <img alt="manga-thumbnail" sizes="100vw" :srcset="comic.thumbnail" :src="comic.thumbnail"
